/**
 * Liste des 101 départements français (métropole + DOM-TOM)
 * code: code officiel (ex: "75", "2A", "971")
 * nom: nom complet
 */
...
/** 20 départements les plus peuplés (pour generateStaticParams) */
export const TOP_20_DEPARTEMENTS = [
  "75", "69", "13", "33", "59", "31", "44", "67", "34", "06",
  "29", "64", "76", "38", "35", "83", "62", "74", "49", "84",
];

export function getDepartementByCode(code: string): Departement | undefined {
  const c = String(code).trim();
  return DEPARTEMENTS.find(
    (d) => d.code === c || d.code === c.padStart(2, "0")
  );
}
